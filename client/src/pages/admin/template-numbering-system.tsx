    ...
    <div className="container mx-auto p-6 max-w-6xl" dir="rtl">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Button 
          ...
          disabled={Array.isArray(templates) && templates.length > 0 ? templates.every(t => t.isNumberLocked) : true}
        >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-900">
                  {Array.isArray(templates) ? templates.filter(t => t.isNumberLocked).length : 0}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-900">
                  {Array.isArray(templates) ? templates.filter(t => t.templateNumber && !t.isNumberLocked).length : 0}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {Array.isArray(templates) ? templates.filter(t => !t.templateNumber).length : 0}
                </p>
              </div>
