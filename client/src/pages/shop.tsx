    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {getTotalItems() > 0 && (
        <div className="fixed bottom-6 right-6 z-50">
          <Button
            onClick={handleCartClick}
            className="bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center gap-3 px-6 py-4 h-auto"
            size="lg"
          >
            <div className="relative">
            ...
            <div className="flex flex-col items-start">
              ...
              <span className="text-xs opacity-90">{getTotalPrice().toFixed(0)} IQD</span>
            </div>
          </Button>
        </div>
      )}
