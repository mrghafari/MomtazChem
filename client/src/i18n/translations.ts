export const translations = {
  en: {
    ...
    categories: {
      ...
      poolChemicals: "Pool Chemicals"
    },

    // Shop Interface
    shopInterface: {
      title: "Chemical Products Shop",
    ...
    adminPanel: {
      ...
      exportSalesReport: "Export Sales Report",
  ...
  ar: {
    ...
    categories: {
      ...
      poolChemicals: "كيماويات المسابح"
    },

    // واجهة المتجر
    shopInterface: {
      title: "متجر المنتجات الكيميائية",
    ...
    adminPanel: {
      ...
      exportSalesReport: "تصدير تقرير المبيعات",
