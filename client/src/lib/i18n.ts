...
export const translations: Record<Language, Translation> = {
  ...
  en: {
    ...
    regularOrdersDesc: 'Orders after payment and completed',
    temporaryOrders: 'Temporary Orders',
    temporaryOrdersDesc: 'Orders in payment grace period',
    otherOrders: 'Other Orders',
    otherOrdersDesc: 'Other order statuses',
    unpaidOrdersWarning: 'Attention: Unpaid Orders',
    unpaidOrdersDesc: 'You have {count} unpaid orders. Please pay or cancel to free inventory.',
    noRegularOrders: 'No regular orders found',
    noTemporaryOrders: 'No temporary orders found',
    noOtherOrders: 'No other orders found',
    temporary: 'Temporary',
    other: 'Other',
    graceperiod: 'Grace Period',
    moreOrders: 'and {count} more orders...',
    viewAllOrders: 'View All Orders ({count})',
    orderHistoryTitle: 'Complete Order History',
  ...
  ar: {
    ...
    // Customer Profile Extended
    regularOrders: 'الطلبات العادية',
    regularOrdersDesc: 'الطلبات بعد الدفع والإكمال',
    temporaryOrders: 'الطلبات المؤقتة',
    temporaryOrdersDesc: 'الطلبات في فترة سماح الدفع',
    otherOrders: 'الطلبات الأخرى',
    otherOrdersDesc: 'حالات الطلبات الأخرى',
    unpaidOrdersWarning: 'تنبيه: طلبات غير مدفوعة',
    unpaidOrdersDesc: 'لديك {count} طلبات غير مدفوعة. يرجى الدفع أو الإلغاء لتحرير المخزون.',
    noRegularOrders: 'لا توجد طلبات عادية',
    noTemporaryOrders: 'لا توجد طلبات مؤقتة',
    noOtherOrders: 'لا توجد طلبات أخرى',
    temporary: 'مؤقت',
    other: 'أخرى',
    graceperiod: 'فترة السماح',
    moreOrders: 'و {count} طلبات أخرى...',
    viewAllOrders: 'عرض جميع الطلبات ({count})',
    orderHistoryTitle: 'تاريخ الطلبات الكامل',
    searchOrders: 'البحث في الطلبات...',
    filterByStatus: 'تصفية حسب الحالة',
    allStatuses: 'جميع الحالات',
    recentOrders: 'الطلبات الحديثة',
    noOrdersYetDesc: 'لم تقم بطلب أي شيء بعد',
