...
ALTER TABLE IF EXISTS ONLY public.smtp_settings DROP CONSTRAINT IF EXISTS smtp_settings_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.financial_transactions DROP CONSTRAINT IF EXISTS financial_transactions_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.email_recipients DROP CONSTRAINT IF EXISTS email_recipients_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.email_logs DROP CONSTRAINT IF EXISTS email_logs_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.email_logs DROP CONSTRAINT IF EXISTS email_logs_smtp_id_fkey;
ALTER TABLE IF EXISTS ONLY public.email_logs DROP CONSTRAINT IF EXISTS email_logs_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_username_key;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_key;
ALTER TABLE IF EXISTS ONLY public.specialists DROP CONSTRAINT IF EXISTS specialists_pkey;
ALTER TABLE IF EXISTS ONLY public.specialists DROP CONSTRAINT IF EXISTS specialists_email_key;
ALTER TABLE IF EXISTS ONLY public.smtp_settings DROP CONSTRAINT IF EXISTS smtp_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.showcase_products DROP CONSTRAINT IF EXISTS showcase_products_sku_key;
ALTER TABLE IF EXISTS ONLY public.showcase_products DROP CONSTRAINT IF EXISTS showcase_products_pkey;
ALTER TABLE IF EXISTS ONLY public.showcase_products DROP CONSTRAINT IF EXISTS showcase_products_barcode_key;
ALTER TABLE IF EXISTS ONLY public.shop_products DROP CONSTRAINT IF EXISTS shop_products_sku_key;
ALTER TABLE IF EXISTS ONLY public.shop_products DROP CONSTRAINT IF EXISTS shop_products_pkey;
ALTER TABLE IF EXISTS ONLY public.shop_categories DROP CONSTRAINT IF EXISTS shop_categories_slug_key;
ALTER TABLE IF EXISTS ONLY public.shop_categories DROP CONSTRAINT IF EXISTS shop_categories_pkey;
...
ALTER TABLE IF EXISTS ONLY public.email_recipients DROP CONSTRAINT IF EXISTS email_recipients_pkey;
ALTER TABLE IF EXISTS ONLY public.email_logs DROP CONSTRAINT IF EXISTS email_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.email_categories DROP CONSTRAINT IF EXISTS email_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.email_categories DROP CONSTRAINT IF EXISTS email_categories_category_key_key;
ALTER TABLE IF EXISTS ONLY public.discount_settings DROP CONSTRAINT IF EXISTS discount_settings_pkey;
...
ALTER TABLE IF EXISTS ONLY public.customer_inquiries DROP CONSTRAINT IF EXISTS customer_inquiries_pkey;
ALTER TABLE IF EXISTS ONLY public.customer_inquiries DROP CONSTRAINT IF EXISTS customer_inquiries_inquiry_number_key;
ALTER TABLE IF EXISTS ONLY public.customer_activities DROP CONSTRAINT IF EXISTS customer_activities_pkey;
ALTER TABLE IF EXISTS ONLY public.crm_customers DROP CONSTRAINT IF EXISTS crm_customers_pkey;
ALTER TABLE IF EXISTS ONLY public.crm_customers DROP CONSTRAINT IF EXISTS crm_customers_email_key;
...
ALTER TABLE IF EXISTS public.showcase_products ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.shop_products ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.shop_categories ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.email_recipients ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.email_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.email_categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.discount_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.customers ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.customer_segments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.customer_inquiries ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.customer_activities ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.crm_customers ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.showcase_products_id_seq;
DROP TABLE IF EXISTS public.showcase_products;
DROP SEQUENCE IF EXISTS public.shop_products_id_seq;
DROP TABLE IF EXISTS public.shop_products;
DROP SEQUENCE IF EXISTS public.shop_categories_id_seq;
...
DROP SEQUENCE IF EXISTS public.email_recipients_id_seq;
...
DROP SEQUENCE IF EXISTS public.email_categories_id_seq;
DROP TABLE IF EXISTS public.email_categories;
DROP SEQUENCE IF EXISTS public.discount_settings_id_seq;
DROP TABLE IF EXISTS public.discount_settings;
DROP SEQUENCE IF EXISTS public.customers_id_seq;
DROP TABLE IF EXISTS public.customers;
DROP SEQUENCE IF EXISTS public.customer_segments_id_seq;
DROP TABLE IF EXISTS public.customer_segments;
DROP SEQUENCE IF EXISTS public.customer_inquiries_id_seq;
DROP TABLE IF EXISTS public.customer_inquiries;
DROP SEQUENCE IF EXISTS public.customer_activities_id_seq;
