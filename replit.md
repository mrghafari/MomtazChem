...
```
Changelog:
- July 11, 2025: COMPLETED product count display fix in shop page - removed incorrect visibleInShop filter that was filtering out all shop products, shop page now correctly displays actual product count (12 products) from shop_products table, fixed frontend filtering logic to show all products available in shop database table instead of incorrectly filtering for non-existent visibleInShop field, customers now see accurate product availability count
