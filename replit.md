...
```
Changelog:
- June 27, 2025: REMOVED redundant login button from shop page - cleaned up shop interface by removing extra login/register button that was redundant with header navigation, keeping only the main header dropdown menu that includes wallet access for streamlined user experience
