...
```
Changelog:
- June 27, 2025: RESTORED customer name display in header after correction - maintained customer name display in both desktop and mobile navigation menus as requested, ensuring proper user identification alongside wallet system functionality
