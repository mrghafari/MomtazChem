...
-- SECURITY: Password reset tokens removed from backup file
\.
...
-- SECURITY: User credentials removed from backup file
-- Admin users must be recreated manually after database restoration
\.
