  ...
  sections: [
    ...
    },
    {
      ...
      subsections: [
        ...
        {
          title: "Centralized Site Management - Complete Feature Set",
          content: "26 integrated administrative functions with drag-and-drop interface:\n\n=== CORE OPERATIONS ===\n• 1. Sync Shop - Product synchronization between showcase and shop catalogs\n• 2. Inquiries - Customer inquiry management and response tracking\n• 3. Barcode - Professional GS1-compliant EAN-13 barcode system with Iraq country code\n• 4. Email Settings - Multi-SMTP configuration with intelligent category-based routing\n• 5. Database Backup - Automated backup systems, migration tools, and PostgreSQL maintenance\n\n=== CUSTOMER & SALES MANAGEMENT ===\n• 6. CRM - Customer relationship management with analytics and automated migration\n• 7. Order Management - 3-department sequential workflow (Financial → Warehouse → Logistics)\n• 8. Payment Settings - Iraqi banking system integration with 3 major banks and invoice generation\n• 9. Wallet Management - Digital wallet system with recharge requests and balance management\n• 10. Geography Analytics - Regional sales tracking and performance analysis (Iraq and Turkey)\n\n=== PRODUCT & INVENTORY CONTROL ===\n• 11. Products - Showcase and shop product catalogs with variant support and specifications\n• 12. Categories - Hierarchical product categorization with standardized shop categories\n• 13. Inventory Management - Independent inventory system with alerts, automation, and real-time monitoring\n• 14. Shop - E-commerce administration with inventory tracking and pricing management\n\n=== COMMUNICATION SYSTEMS ===\n• 15. SMS - Customer notification and verification systems with admin-configurable settings\n• 16. SMTP Test - Comprehensive email connectivity testing and validation systems\n\n=== USER & SECURITY MANAGEMENT ===\n• 17. Super Admin - Admin account management and verification system with email/SMS authentication\n• 18. User Management - Multi-role admin system with department-based access control\n• 19. Department Users - Team management with role assignments and access control\n\n=== CONTENT & SEO ===\n• 20. SEO - Comprehensive multilingual SEO with sitemap generation and 4-language support\n• 21. Content Management - Dynamic multilingual content editing system (430+ items in 4 languages)\n\n=== ADVANCED FEATURES ===\n• 22. AI Settings - Smart SKU generation, product recommendations, and OpenAI API integration\n• 23. Factory - Production line and manufacturing operations management\n• 24. Procedures - Document management system for operational procedures and methods\n• 25. Refresh Control - Centralized timing management for all department interfaces\n• 26. [Future Enhancement Slot] - Reserved for additional administrative functionality"
        }
      ]
    },
    {
...
const projectProposalFA: DocumentationData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: "پلتفرم شامل 26 ماژول مدیریتی یکپارچه است که هر کدام عملکرد تخصصی برای جنبه‌های مختلف عملیات کسب‌وکار فراهم می‌کند.",
      subsections: [
        {
        ...
        {
          title: "۱۱. سیستم مدیریت مرکزی سایت - مجموعه کامل ویژگی‌ها",
          content: "26 عملکرد مدیریتی یکپارچه با رابط کشیدن و رها کردن:\n\n=== عملیات اصلی ===\n• 1. همگام‌سازی فروشگاه - همگام‌سازی محصولات\n• 2. استعلامات - مدیریت پرسش‌های مشتریان\n• 3. بارکد - سیستم بارکد EAN-13 استاندارد GS1\n• 4. تنظیمات ایمیل - پیکربندی چند SMTP\n• 5. پشتیبان‌گیری - سیستم‌های پشتیبان‌گیری خودکار\n\n=== مدیریت مشتری و فروش ===\n• 6. CRM - مدیریت روابط مشتری\n• 7. مدیریت سفارشات - گردش کار 3 بخشی\n• 8. تنظیمات پرداخت - ادغام بانک‌های عراقی\n• 9. مدیریت کیف پول - سیستم کیف پول دیجیتال\n• 10. تجزیه و تحلیل جغرافیایی - ردیابی فروش منطقه‌ای\n\n=== کنترل محصولات و موجودی ===\n• 11. محصولات - کاتالوگ محصولات\n• 12. دسته‌بندی‌ها - دسته‌بندی سلسله‌مراتبی\n• 13. مدیریت موجودی - سیستم موجودی مستقل\n• 14. فروشگاه - مدیریت تجارت الکترونیک\n\n=== سیستم‌های ارتباطی ===\n• 15. SMS - سیستم اطلاع‌رسانی مشتری\n• 16. تست SMTP - تست اتصال ایمیل\n\n=== مدیریت کاربر و امنیت ===\n• 17. سوپر ادمین - مدیریت حساب ادمین\n• 18. مدیریت کاربران - سیستم ادمین چندنقشه\n• 19. کاربران بخش - مدیریت تیم\n\n=== محتوا و SEO ===\n• 20. SEO - مدیریت SEO چندزبانه\n• 21. مدیریت محتوا - سیستم ویرایش محتوا\n\n=== ویژگی‌های پیشرفته ===\n• 22. تنظیمات AI - تولید SKU هوشمند\n• 23. کارخانه - مدیریت عملیات تولید\n• 24. روش‌ها - مدیریت اسناد\n• 25. کنترل بازخوانی - مدیریت زمان‌بندی\n• 26. [اسلات توسعه آینده] - برای عملکرد اضافی"
        }
      ]
    },
    {
